...
if __name__== '__main__':
    mission_description = ('Simple data collection mission, intended for data collection while controling the boat'
    ...
    with boat:
        while True:
            print(hlp.process_gga_and_save_data(boat, data_keys=data_to_be_collected, post_fix=args.mission_postfix, delay=1.0))